...
public class VerificarEmpleadoFachadaimpl {
    ...
    public final EmpleadoDTO ejecutar(EmpleadoDTO empleado){
        try{
            ...
            var mensajeUsuario = "Se ha presentado un problema tratando de verificar la información del empleado";
            var mensajeTecnico = "Se ha presentado un problema INESPERADO tratando de verificar las credenciales en el método ejecutar de la clase CrearTareaFachadaImpl";
